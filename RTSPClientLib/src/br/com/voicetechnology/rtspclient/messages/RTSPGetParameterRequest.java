...
public class RTSPGetParameterRequest extends RTSPRequest {
    public RTSPGetParameterRequest() { }

    public RTSPGetParameterRequest(String messageLine) throws URISyntaxException
    {
        super(messageLine);
    }
