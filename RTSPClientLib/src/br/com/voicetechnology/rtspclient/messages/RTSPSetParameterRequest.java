...
public class RTSPSetParameterRequest extends RTSPRequest {
    public RTSPSetParameterRequest() { }

    public RTSPSetParameterRequest(String messageLine) throws URISyntaxException
    {
        super(messageLine);
    }
