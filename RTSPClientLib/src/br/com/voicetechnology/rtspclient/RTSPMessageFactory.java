...
import br.com.voicetechnology.rtspclient.messages.RTSPAnnounceRequest;
import br.com.voicetechnology.rtspclient.messages.RTSPDescribeRequest;
import br.com.voicetechnology.rtspclient.messages.RTSPGetParameterRequest;
import br.com.voicetechnology.rtspclient.messages.RTSPOptionsRequest;
import br.com.voicetechnology.rtspclient.messages.RTSPPauseRequest;
import br.com.voicetechnology.rtspclient.messages.RTSPPlayRequest;
import br.com.voicetechnology.rtspclient.messages.RTSPRecordRequest;
import br.com.voicetechnology.rtspclient.messages.RTSPSetParameterRequest;
...
public class RTSPMessageFactory implements MessageFactory
{
	...
	static
	{
		...
		try
		{
            ...
            requestMap.put(Method.PAUSE, RTSPPauseRequest.class);
            requestMap.put(Method.RECORD, RTSPRecordRequest.class);
            requestMap.put(Method.GET_PARAMETER, RTSPGetParameterRequest.class);
            requestMap.put(Method.SET_PARAMETER, RTSPSetParameterRequest.class);
            requestMap.put(Method.ANNOUNCE, RTSPAnnounceRequest.class);
		}
        catch(Exception e)
		{
			e.printStackTrace();
